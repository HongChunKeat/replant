...
class UserInventoryModel extends DbBase
{
    /**
    ...
    public static function defaultWhere($specifiedTable = "")
    {
        ...
        return self::whereNull($specifiedTable . "used_at")
            ->whereNull($specifiedTable . "removed_at")
            ->whereNull($specifiedTable . "marketed_at");
    }
}
